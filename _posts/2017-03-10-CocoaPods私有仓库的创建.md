...
> 本文发布于 [BY Blog](http://alishang.github.io)、[简书](http://www.jianshu.com/p/d2d98298b1b8) 转载请保留链接
> 
> 上一篇文章 [《CocoaPods公有仓库的创建》](http://alishang.top/2017/03/08/CocoaPods公有仓库的创建/)
...
在上一篇[《CocoaPods公有仓库的创建》](http://alishang.top/2017/03/08/CocoaPods公有仓库的创建/)中我们了解到，`master` 目录中只存放 代码库 的描述文件，而不是存放代码。就像这样
...
Pod::Spec.new do |s|
  ...
  s.social_media_url   = "http://alishang.github.io" # 个人主页
...
通过 [《CocoaPods私有仓库的创建》](http://alishang.top/2017-03-10-CocoaPods私有仓库的创建/) 和 [《CocoaPods公有仓库的创建](http://alishang.top/2017/03/08/CocoaPods公有仓库的创建/)》这两篇文章，相信大家对CocoaPods的工作原理都有了更深层次的了解。
